...
```{r}
liz<- read.GenBank("JF806202", as.character= TRUE)
```


```{r}
write.dna(liz, file ="lizard_fasta_1.fasta", format = "fasta", append = FALSE, nbcol = 6, colsep = " ", colw = 10)
```


```{r}
lizzy <- read.fasta(file = "lizard_fasta_1.fasta")
```
